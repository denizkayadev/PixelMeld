...
#[derive(Debug)]
pub struct PixelMeldProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PixelMeldProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PixelMeld processing");
    
    let mut processor = PixelMeldProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PixelMeldProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PixelMeldProcessor::new(false);
